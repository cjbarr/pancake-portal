...
class Pals extends Component {
    ...
    state = {
        pals: [{ name: 'Corey', picture: '/images/corey.jpg', about:'Corey loves making pancakes, and is a junior developer based out of the Twin Cities. This is his silly page he created during COVID-19.' },
